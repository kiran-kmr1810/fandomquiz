...
class getjson extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return FutureBuilder(
      future: DefaultAssetBundle.of(context).loadString('assets/Story Quiz.json'),
            ...
            children: <Widget>[
              Expanded(
                ...
                child: Container(
                  ...
                  child: Text(
                    mydata[0][i.toString()],
                    style: TextStyle(fontSize: 16.0, fontFamily: "StarR", color: Colors.black ,backgroundColor: Colors.white),
                  ),
                ),
              ),
              Expanded(
